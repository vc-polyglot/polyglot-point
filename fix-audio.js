...
fs.writeFileSync(
  path.join(process.cwd(), 'packages/temperament-lab/frontend/src/services/audio.ts'),
...
// También mejorar el mensaje de error en usePitchDetection
const hookPath = path.join(process.cwd(), 'packages/temperament-lab/frontend/src/hooks/usePitchDetection.ts');
...
console.log('OK — audio.ts y usePitchDetection.ts actualizados');
