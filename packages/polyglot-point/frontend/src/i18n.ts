export const translations = {
  es: {
    ...
    phrases: [
      "Escribe. Aprende. Mejora.",
      "Practica sin miedo",
      "Tu idioma, tu ritmo",
      "Aprende haciendo"
    ],
    placeholder: "Escribe y practica",
    inputplaceholder: "Escribe y practica",
    send: "Enviar",
    sending: "Enviando...",
  ...
  en: {
    ...
    paywall: {
      ...
      premiumDesc: "50 messages per day, all languages",
      proLabel: "Pro",
      proPrice: "$29/month",
    ...
    privacy: "Privacy",
    terms: "Terms",
    onboarding: "Write something in the language you want to practice and I'll help you improve it. No judgment, mistakes are welcome here!"
  },
  fr: {
    title: "Polyglot Point",
    phrases: [
  ...
  it: {
    title: "Polyglot Point",
    phrases: [
      "Scrivi. Impara. Migliora.",
      "Pratica senza paura",
      "La tua lingua, il tuo ritmo",
      "Impara facendo"
    ],
    placeholder: "Escribe y practica",
    inputplaceholder: "Escribe y practica",
  ...
  de: {
    ...
    paywall: {
      ...
      premiumDesc: "50 Nachrichten pro Tag, alle Sprachen",
      proLabel: "Pro",
      proPrice: "29$/Monat",
  ...
  pt: {
    title: "Polyglot Point",
    phrases: [
      "Escreva. Aprenda. Melhore.",
      "Pratique sem medo",
      "Seu idioma, seu ritmo",
      "Aprenda fazendo"
    ],
    placeholder: "Escribe y practica",
    inputplaceholder: "Escribe y practica",
