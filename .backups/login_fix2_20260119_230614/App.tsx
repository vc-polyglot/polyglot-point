      ...
      <div className="login-artistic">
        ...
        <div className="login-artistic-content">
          <div className="login-glass-panel" style={{ margin: '0 auto' }}>
            ...
            <p className="login-glass-text">Cargando...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="login-artistic">
        ...
        <div className="login-artistic-content">
          <div className="login-artistic-left">
            {/* MODIFICADO: Textos del diseño "Fluid Threshold" */}
          ...
          <div className="login-artistic-right">
            <div className="login-glass-panel">
              {/* MODIFICADO: Encabezado del panel */}
              <h1 className="login-glass-heading">Bienvenido</h1>
              <p className="login-glass-text">
                Inicia sesión para continuar
              </p>
              {/* BOTÓN ORIGINAL - NO MODIFICADO */}
              ...
              {/* MODIFICADO: Nota al pie */}
              <p className="login-artistic-note">
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="app">
        ...
        <header className="app-header">
          ...
          <div className="header-right">
            <div className="language-dropdown" role="navigation" aria-label="Language selector">
              ...
              >
                <span className="lang-flag" aria-hidden="true">{activeIdioma.flag}</span>
              ...
              {langDropdownOpen && (
                <div className="lang-dropdown-menu" role="listbox" aria-label="Available languages">
                  {availableIdiomas.map((idioma) => (
                    ...
                    >
                      <span className="lang-flag" aria-hidden="true">{idioma.flag}</span>
            ...
            <button className="btn-logout" onClick={handleLogout}>{uiT.logout}</button>
          </div>
        </header>
      ...
      <div className="chat-input-floating">
        <div className="input-card">
          <textarea
            ref={textareaRef}
            value={text}
            onChange={(e) => { isUserTypingRef.current = true; setText(e.target.value.slice(0, MAX_CHARS)); }}
      ...
      <div className="footer-links-fixed">
        <a href="/privacy-policy.html" target="_blank" rel="noreferrer">{uiT.privacy}</a>
        <a href="/terms" target="_blank" rel="noreferrer">{uiT.terms}</a>
      </div>
        ...
        <div className="paywall-overlay">
          <div className="paywall-card">
            ...
            <div className="paywall-footer">
              <button className="btn-later" onClick={() => { if (remaining > 0) setShowPaywall(false); }}>
